...
// ─────────────────────────────────────────────────────────────
// Stock data — comprehensive fundamentals + technical + sentiment fields.
// Fields:
//   symbol, name, sector, exchange(US only), price, change(1D%), volume,
//   mktcap(label), mktcapRaw(IDR/USD), currency,
//   pe, eps, roe, roa, der, div, net_margin, eps_growth, rev_growth, fcf_growth,
//   pbv, peg, ev_ebitda, w52h, w52l, beta,
//   rsi, macd(bullish|bearish|neutral), vol_chg_30d(%),
//   rel_strength(vs index, %),
//   foreign_flow(B IDR / M USD), inst_own(%), insider(buying|selling|neutral),
//   sentiment(1-100), rate_env, inflation, gdp_trend, idx_trend
// ─────────────────────────────────────────────────────────────

const IDX_STOCKS_DATA = [
    // ── Big Caps / LQ45 Core ───────────────────────────────────────────────
    { symbol:'BBCA',  name:'Bank Central Asia',         sector:'Banking',        price:9200,   change:1.32,  volume:42_500_000,   mktcap:'1.12T', mktcapRaw:1120e9, currency:'IDR', pe:28.4, eps:324,  roe:22.1, roa:3.1,  der:5.8,  div:2.1,  net_margin:28.4, eps_growth:8.2,  rev_growth:11.3, fcf_growth:7.5,  pbv:4.8,  peg:3.46, ev_ebitda:14.2, w52h:10200, w52l:7800,  beta:0.72, rsi:56, macd:'bullish',  vol_chg_30d:12,  rel_strength:4.2,  foreign_flow:-120, inst_own:68, insider:'neutral', sentiment:72, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'BMRI',  name:'Bank Mandiri',               sector:'Banking',        price:5975,   change:2.10,  volume:38_200_000,   mktcap:'580B',  mktcapRaw:580e9,  currency:'IDR', pe:12.1, eps:494,  roe:18.6, roa:2.4,  der:6.2,  div:3.8,  net_margin:24.1, eps_growth:14.3, rev_growth:9.8,  fcf_growth:10.2, pbv:2.2,  peg:0.84, ev_ebitda:9.1,  w52h:6900,  w52l:4800,  beta:0.88, rsi:61, macd:'bullish',  vol_chg_30d:18,  rel_strength:6.1,  foreign_flow:85,   inst_own:62, insider:'buying',  sentiment:68, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'BBRI',  name:'Bank Rakyat Indonesia',      sector:'Banking',        price:4380,   change:-0.45, volume:61_000_000,   mktcap:'650B',  mktcapRaw:650e9,  currency:'IDR', pe:11.3, eps:388,  roe:17.2, roa:2.2,  der:6.5,  div:4.2,  net_margin:22.8, eps_growth:10.1, rev_growth:12.4, fcf_growth:8.9,  pbv:2.0,  peg:1.12, ev_ebitda:8.4,  w52h:5000,  w52l:3550,  beta:0.92, rsi:48, macd:'neutral',  vol_chg_30d:-5,  rel_strength:-1.2, foreign_flow:-210, inst_own:58, insider:'neutral', sentiment:60, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'BBNI',  name:'Bank Negara Indonesia',      sector:'Banking',        price:4350,   change:0.81,  volume:22_100_000,   mktcap:'162B',  mktcapRaw:162e9,  currency:'IDR', pe:8.9,  eps:488,  roe:14.8, roa:1.8,  der:5.9,  div:4.5,  net_margin:19.2, eps_growth:12.4, rev_growth:8.7,  fcf_growth:6.4,  pbv:1.3,  peg:0.72, ev_ebitda:7.2,  w52h:5150,  w52l:3600,  beta:1.01, rsi:52, macd:'neutral',  vol_chg_30d:3,   rel_strength:1.8,  foreign_flow:-45,  inst_own:55, insider:'neutral', sentiment:62, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'BRIS',  name:'Bank Syariah Indonesia',     sector:'Banking',        price:1780,   change:3.49,  volume:45_000_000,   mktcap:'118B',  mktcapRaw:118e9,  currency:'IDR', pe:14.6, eps:122,  roe:16.4, roa:1.9,  der:5.2,  div:2.1,  net_margin:21.3, eps_growth:22.1, rev_growth:18.4, fcf_growth:15.2, pbv:2.4,  peg:0.66, ev_ebitda:10.4, w52h:2200,  w52l:1400,  beta:1.12, rsi:65, macd:'bullish',  vol_chg_30d:35,  rel_strength:9.2,  foreign_flow:120,  inst_own:42, insider:'buying',  sentiment:78, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'TLKM',  name:'Telkom Indonesia',           sector:'Infrastructure', price:3130,   change:-1.08, volume:29_400_000,   mktcap:'310B',  mktcapRaw:310e9,  currency:'IDR', pe:14.7, eps:213,  roe:14.3, roa:7.2,  der:0.9,  div:5.1,  net_margin:18.6, eps_growth:-2.4, rev_growth:4.1,  fcf_growth:-5.2, pbv:2.1,  peg:null, ev_ebitda:7.8,  w52h:3850,  w52l:2700,  beta:0.65, rsi:41, macd:'bearish',  vol_chg_30d:-12, rel_strength:-4.8, foreign_flow:-380, inst_own:72, insider:'neutral', sentiment:42, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'EXCL',  name:'XL Axiata',                  sector:'Infrastructure', price:2110,   change:1.44,  volume:14_800_000,   mktcap:'22B',   mktcapRaw:22e9,   currency:'IDR', pe:18.2, eps:116,  roe:8.4,  roa:3.1,  der:1.4,  div:1.8,  net_margin:8.9,  eps_growth:41.2, rev_growth:6.8,  fcf_growth:38.1, pbv:1.5,  peg:0.44, ev_ebitda:5.8,  w52h:2700,  w52l:1650,  beta:0.82, rsi:54, macd:'bullish',  vol_chg_30d:8,   rel_strength:2.4,  foreign_flow:18,   inst_own:36, insider:'neutral', sentiment:58, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'ASII',  name:'Astra International',        sector:'Consumer',       price:4890,   change:0.62,  volume:18_700_000,   mktcap:'198B',  mktcapRaw:198e9,  currency:'IDR', pe:9.8,  eps:499,  roe:12.4, roa:5.8,  der:0.7,  div:5.8,  net_margin:7.2,  eps_growth:4.1,  rev_growth:6.2,  fcf_growth:2.8,  pbv:1.2,  peg:2.39, ev_ebitda:6.4,  w52h:5650,  w52l:4200,  beta:0.79, rsi:50, macd:'neutral',  vol_chg_30d:2,   rel_strength:0.4,  foreign_flow:42,   inst_own:64, insider:'neutral', sentiment:55, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'HMSP',  name:'HM Sampoerna',               sector:'Consumer',       price:690,    change:-1.28, volume:32_100_000,   mktcap:'80B',   mktcapRaw:80e9,   currency:'IDR', pe:11.4, eps:60,   roe:58.2, roa:19.4, der:0.3,  div:9.1,  net_margin:12.8, eps_growth:-8.1, rev_growth:-3.2, fcf_growth:-6.4, pbv:6.6,  peg:null, ev_ebitda:9.2,  w52h:1110,  w52l:640,   beta:0.47, rsi:38, macd:'bearish',  vol_chg_30d:-18, rel_strength:-7.2, foreign_flow:-92,  inst_own:74, insider:'neutral', sentiment:38, rate_env:'stable',  inflation:'rising',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'UNVR',  name:'Unilever Indonesia',         sector:'Consumer',       price:2610,   change:-2.67, volume:12_800_000,   mktcap:'99B',   mktcapRaw:99e9,   currency:'IDR', pe:19.2, eps:136,  roe:68.4, roa:18.2, der:2.1,  div:4.9,  net_margin:16.1, eps_growth:-14.2,rev_growth:-6.8, fcf_growth:-11.4,pbv:13.2, peg:null, ev_ebitda:12.4, w52h:4380,  w52l:2100,  beta:0.54, rsi:33, macd:'bearish',  vol_chg_30d:-22, rel_strength:-9.4, foreign_flow:-180, inst_own:68, insider:'selling', sentiment:31, rate_env:'stable',  inflation:'rising',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'ICBP',  name:'Indofood CBP Sukses',        sector:'Consumer',       price:10325,  change:-0.24, volume:6_200_000,    mktcap:'121B',  mktcapRaw:121e9,  currency:'IDR', pe:18.6, eps:555,  roe:14.1, roa:8.2,  der:0.8,  div:2.8,  net_margin:9.4,  eps_growth:5.2,  rev_growth:7.8,  fcf_growth:4.1,  pbv:2.6,  peg:3.58, ev_ebitda:11.8, w52h:11400, w52l:8600,  beta:0.61, rsi:47, macd:'neutral',  vol_chg_30d:-4,  rel_strength:-0.8, foreign_flow:12,   inst_own:48, insider:'neutral', sentiment:54, rate_env:'stable',  inflation:'rising',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'INDF',  name:'Indofood Sukses Makmur',     sector:'Consumer',       price:6425,   change:-0.77, volume:8_900_000,    mktcap:'57B',   mktcapRaw:57e9,   currency:'IDR', pe:7.6,  eps:846,  roe:9.8,  roa:4.4,  der:0.7,  div:5.2,  net_margin:5.8,  eps_growth:3.8,  rev_growth:5.4,  fcf_growth:2.1,  pbv:0.7,  peg:2.0,  ev_ebitda:5.6,  w52h:7600,  w52l:5400,  beta:0.69, rsi:44, macd:'neutral',  vol_chg_30d:-8,  rel_strength:-2.1, foreign_flow:-28,  inst_own:52, insider:'neutral', sentiment:51, rate_env:'stable',  inflation:'rising',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'KLBF',  name:'Kalbe Farma',                sector:'Healthcare',     price:1510,   change:1.41,  volume:18_400_000,   mktcap:'71B',   mktcapRaw:71e9,   currency:'IDR', pe:20.4, eps:74,   roe:14.8, roa:11.2, der:0.2,  div:2.8,  net_margin:11.4, eps_growth:8.4,  rev_growth:9.2,  fcf_growth:6.8,  pbv:3.0,  peg:2.43, ev_ebitda:14.6, w52h:1870,  w52l:1275,  beta:0.68, rsi:53, macd:'neutral',  vol_chg_30d:6,   rel_strength:2.2,  foreign_flow:24,   inst_own:44, insider:'neutral', sentiment:63, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'SIDO',  name:'Industri Jamu & Farmasi',    sector:'Healthcare',     price:742,    change:2.21,  volume:11_200_000,   mktcap:'22B',   mktcapRaw:22e9,   currency:'IDR', pe:14.8, eps:50,   roe:22.8, roa:17.4, der:0.0,  div:6.4,  net_margin:18.2, eps_growth:6.1,  rev_growth:7.4,  fcf_growth:5.8,  pbv:3.4,  peg:2.43, ev_ebitda:10.2, w52h:920,   w52l:620,   beta:0.52, rsi:58, macd:'bullish',  vol_chg_30d:14,  rel_strength:5.1,  foreign_flow:8,    inst_own:31, insider:'neutral', sentiment:68, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'HEAL',  name:'Medikaloka Hermina',         sector:'Healthcare',     price:1565,   change:-1.57, volume:9_800_000,    mktcap:'9B',    mktcapRaw:9e9,    currency:'IDR', pe:16.8, eps:93,   roe:11.3, roa:6.8,  der:0.6,  div:0.8,  net_margin:9.4,  eps_growth:12.1, rev_growth:14.8, fcf_growth:8.2,  pbv:1.9,  peg:1.39, ev_ebitda:10.8, w52h:2100,  w52l:1200,  beta:0.88, rsi:42, macd:'bearish',  vol_chg_30d:-14, rel_strength:-3.2, foreign_flow:-12,  inst_own:28, insider:'neutral', sentiment:48, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'MIKA',  name:'Mitra Keluarga Karyasehat',  sector:'Healthcare',     price:2420,   change:0.83,  volume:5_100_000,    mktcap:'29B',   mktcapRaw:29e9,   currency:'IDR', pe:26.4, eps:92,   roe:18.7, roa:14.2, der:0.1,  div:1.9,  net_margin:22.4, eps_growth:10.2, rev_growth:12.4, fcf_growth:9.1,  pbv:4.9,  peg:2.59, ev_ebitda:18.2, w52h:3100,  w52l:2050,  beta:0.58, rsi:54, macd:'bullish',  vol_chg_30d:8,   rel_strength:3.1,  foreign_flow:6,    inst_own:32, insider:'neutral', sentiment:64, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'ANTM',  name:'Aneka Tambang',              sector:'Mining',         price:1655,   change:3.44,  volume:84_000_000,   mktcap:'39B',   mktcapRaw:39e9,   currency:'IDR', pe:21.4, eps:77,   roe:8.9,  roa:5.1,  der:0.4,  div:1.2,  net_margin:8.2,  eps_growth:18.4, rev_growth:14.2, fcf_growth:22.8, pbv:1.9,  peg:1.16, ev_ebitda:12.4, w52h:2200,  w52l:1150,  beta:1.45, rsi:68, macd:'bullish',  vol_chg_30d:42,  rel_strength:12.8, foreign_flow:320,  inst_own:34, insider:'buying',  sentiment:74, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'ADRO',  name:'Adaro Energy Indonesia',     sector:'Mining',         price:2280,   change:2.78,  volume:55_300_000,   mktcap:'73B',   mktcapRaw:73e9,   currency:'IDR', pe:6.2,  eps:368,  roe:21.7, roa:14.8, der:0.3,  div:8.4,  net_margin:21.4, eps_growth:-18.2,rev_growth:-12.4,fcf_growth:-14.2,pbv:1.3,  peg:null, ev_ebitda:4.2,  w52h:2900,  w52l:1750,  beta:1.22, rsi:62, macd:'bullish',  vol_chg_30d:28,  rel_strength:8.4,  foreign_flow:142,  inst_own:48, insider:'buying',  sentiment:66, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'ITMG',  name:'Indo Tambangraya Megah',     sector:'Mining',         price:24450,  change:4.07,  volume:4_100_000,    mktcap:'27B',   mktcapRaw:27e9,   currency:'IDR', pe:5.1,  eps:4794, roe:39.2, roa:26.4, der:0.1,  div:14.6, net_margin:22.8, eps_growth:-22.4,rev_growth:-18.1,fcf_growth:-19.8,pbv:2.0,  peg:null, ev_ebitda:3.2,  w52h:31000, w52l:18500, beta:1.31, rsi:64, macd:'bullish',  vol_chg_30d:24,  rel_strength:9.8,  foreign_flow:88,   inst_own:52, insider:'neutral', sentiment:65, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'PTBA',  name:'Bukit Asam',                 sector:'Mining',         price:2580,   change:1.96,  volume:28_400_000,   mktcap:'30B',   mktcapRaw:30e9,   currency:'IDR', pe:6.8,  eps:380,  roe:28.4, roa:19.2, der:0.2,  div:11.2, net_margin:24.1, eps_growth:-14.8,rev_growth:-8.2, fcf_growth:-12.4,pbv:1.9,  peg:null, ev_ebitda:3.8,  w52h:3280,  w52l:2100,  beta:1.18, rsi:58, macd:'bullish',  vol_chg_30d:18,  rel_strength:7.2,  foreign_flow:62,   inst_own:56, insider:'neutral', sentiment:62, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'MDKA',  name:'Merdeka Copper Gold',        sector:'Mining',         price:2140,   change:5.17,  volume:62_800_000,   mktcap:'47B',   mktcapRaw:47e9,   currency:'IDR', pe:48.6, eps:44,   roe:6.4,  roa:3.8,  der:0.8,  div:0.2,  net_margin:6.8,  eps_growth:84.2, rev_growth:42.4, fcf_growth:68.1, pbv:3.1,  peg:0.58, ev_ebitda:18.4, w52h:3200,  w52l:1480,  beta:1.68, rsi:72, macd:'bullish',  vol_chg_30d:68,  rel_strength:18.4, foreign_flow:284,  inst_own:28, insider:'buying',  sentiment:76, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'GOTO',  name:'GoTo Gojek Tokopedia',       sector:'Technology',     price:64,     change:5.52,  volume:9_823_000_000,mktcap:'8B',   mktcapRaw:8e9,    currency:'IDR', pe:null, eps:-12,  roe:-18.4,roa:-8.2, der:0.3,  div:0,    net_margin:-24.2,eps_growth:44.2, rev_growth:22.1, fcf_growth:38.4, pbv:1.2,  peg:null, ev_ebitda:null, w52h:120,   w52l:48,    beta:1.82, rsi:67, macd:'bullish',  vol_chg_30d:84,  rel_strength:14.2, foreign_flow:480,  inst_own:22, insider:'buying',  sentiment:72, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'EMTK',  name:'Elang Mahkota Teknologi',    sector:'Technology',     price:435,    change:3.10,  volume:48_200_000,   mktcap:'12B',   mktcapRaw:12e9,   currency:'IDR', pe:22.1, eps:20,   roe:4.8,  roa:2.8,  der:0.2,  div:0.5,  net_margin:8.4,  eps_growth:12.4, rev_growth:8.8,  fcf_growth:6.2,  pbv:1.1,  peg:1.78, ev_ebitda:8.2,  w52h:580,   w52l:310,   beta:1.24, rsi:58, macd:'bullish',  vol_chg_30d:22,  rel_strength:6.4,  foreign_flow:28,   inst_own:18, insider:'neutral', sentiment:61, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'DMMX',  name:'Digital Mediatama Maxima',   sector:'Technology',     price:118,    change:8.26,  volume:124_000_000,  mktcap:'3B',    mktcapRaw:3e9,    currency:'IDR', pe:null, eps:-8,   roe:-24.1,roa:-12.4,der:0.4,  div:0,    net_margin:-18.4,eps_growth:28.4, rev_growth:64.2, fcf_growth:null, pbv:2.8,  peg:null, ev_ebitda:null, w52h:182,   w52l:62,    beta:2.14, rsi:74, macd:'bullish',  vol_chg_30d:124, rel_strength:22.4, foreign_flow:18,   inst_own:12, insider:'buying',  sentiment:78, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'JSMR',  name:'Jasa Marga',                 sector:'Infrastructure', price:4130,   change:-0.84, volume:7_600_000,    mktcap:'30B',   mktcapRaw:30e9,   currency:'IDR', pe:15.3, eps:270,  roe:7.4,  roa:2.8,  der:2.8,  div:3.2,  net_margin:14.2, eps_growth:6.8,  rev_growth:8.4,  fcf_growth:-2.4, pbv:1.1,  peg:2.25, ev_ebitda:9.4,  w52h:5100,  w52l:3600,  beta:0.73, rsi:44, macd:'neutral',  vol_chg_30d:-6,  rel_strength:-1.8, foreign_flow:-22,  inst_own:82, insider:'neutral', sentiment:48, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'PTPP',  name:'PP Persero',                 sector:'Infrastructure', price:785,    change:-3.19, volume:14_900_000,   mktcap:'4B',    mktcapRaw:4e9,    currency:'IDR', pe:null, eps:-95,  roe:-8.1, roa:-2.4, der:3.4,  div:0,    net_margin:-9.8, eps_growth:null, rev_growth:-14.2,fcf_growth:null, pbv:0.4,  peg:null, ev_ebitda:null, w52h:1250,  w52l:620,   beta:1.41, rsi:36, macd:'bearish',  vol_chg_30d:-28, rel_strength:-10.4,foreign_flow:-64,  inst_own:72, insider:'selling', sentiment:28, rate_env:'rising',  inflation:'rising',  gdp_trend:'growing',  idx_trend:'downtrend' },
    { symbol:'WSKT',  name:'Waskita Karya',              sector:'Infrastructure', price:128,    change:-4.48, volume:38_400_000,   mktcap:'2B',    mktcapRaw:2e9,    currency:'IDR', pe:null, eps:-42,  roe:-28.4,roa:-6.8, der:6.8,  div:0,    net_margin:-18.4,eps_growth:null, rev_growth:-22.4,fcf_growth:null, pbv:0.3,  peg:null, ev_ebitda:null, w52h:342,   w52l:96,    beta:1.84, rsi:28, macd:'bearish',  vol_chg_30d:-42, rel_strength:-16.2,foreign_flow:-124, inst_own:78, insider:'selling', sentiment:18, rate_env:'rising',  inflation:'rising',  gdp_trend:'growing',  idx_trend:'downtrend' },
    { symbol:'BSDE',  name:'Bumi Serpong Damai',         sector:'Property',       price:1020,   change:1.99,  volume:22_100_000,   mktcap:'18B',   mktcapRaw:18e9,   currency:'IDR', pe:7.4,  eps:138,  roe:6.2,  roa:4.2,  der:0.5,  div:1.5,  net_margin:18.4, eps_growth:14.2, rev_growth:18.4, fcf_growth:12.8, pbv:0.4,  peg:0.52, ev_ebitda:5.8,  w52h:1350,  w52l:750,   beta:1.08, rsi:56, macd:'bullish',  vol_chg_30d:16,  rel_strength:5.8,  foreign_flow:42,   inst_own:24, insider:'neutral', sentiment:62, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'CTRA',  name:'Ciputra Development',        sector:'Property',       price:1260,   change:2.44,  volume:19_300_000,   mktcap:'23B',   mktcapRaw:23e9,   currency:'IDR', pe:9.1,  eps:138,  roe:7.8,  roa:4.8,  der:0.6,  div:1.4,  net_margin:16.2, eps_growth:18.8, rev_growth:22.4, fcf_growth:14.2, pbv:0.7,  peg:0.48, ev_ebitda:6.4,  w52h:1650,  w52l:950,   beta:1.15, rsi:62, macd:'bullish',  vol_chg_30d:22,  rel_strength:7.4,  foreign_flow:64,   inst_own:28, insider:'neutral', sentiment:66, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'PWON',  name:'Pakuwon Jati',               sector:'Property',       price:540,    change:1.12,  volume:31_400_000,   mktcap:'26B',   mktcapRaw:26e9,   currency:'IDR', pe:8.3,  eps:65,   roe:9.1,  roa:5.8,  der:0.4,  div:1.8,  net_margin:24.1, eps_growth:8.4,  rev_growth:11.2, fcf_growth:6.4,  pbv:0.8,  peg:0.99, ev_ebitda:7.2,  w52h:730,   w52l:420,   beta:0.98, rsi:54, macd:'neutral',  vol_chg_30d:8,   rel_strength:2.8,  foreign_flow:18,   inst_own:22, insider:'neutral', sentiment:58, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'SMRA',  name:'Summarecon Agung',           sector:'Property',       price:584,    change:3.72,  volume:26_800_000,   mktcap:'8B',    mktcapRaw:8e9,    currency:'IDR', pe:12.4, eps:47,   roe:7.2,  roa:3.8,  der:1.1,  div:1.2,  net_margin:12.8, eps_growth:24.2, rev_growth:28.4, fcf_growth:18.4, pbv:0.9,  peg:0.51, ev_ebitda:8.4,  w52h:740,   w52l:430,   beta:1.22, rsi:64, macd:'bullish',  vol_chg_30d:28,  rel_strength:8.8,  foreign_flow:32,   inst_own:18, insider:'neutral', sentiment:64, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'PGAS',  name:'Perusahaan Gas Negara',      sector:'Energy',         price:1285,   change:1.10,  volume:41_800_000,   mktcap:'31B',   mktcapRaw:31e9,   currency:'IDR', pe:8.4,  eps:153,  roe:11.4, roa:5.8,  der:0.8,  div:4.8,  net_margin:11.8, eps_growth:-4.2, rev_growth:2.4,  fcf_growth:-8.2, pbv:0.9,  peg:null, ev_ebitda:5.4,  w52h:1640,  w52l:1100,  beta:0.94, rsi:48, macd:'neutral',  vol_chg_30d:4,   rel_strength:0.4,  foreign_flow:-28,  inst_own:62, insider:'neutral', sentiment:52, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'MEDC',  name:'Medco Energi Internasional', sector:'Energy',         price:1140,   change:2.52,  volume:18_400_000,   mktcap:'13B',   mktcapRaw:13e9,   currency:'IDR', pe:6.2,  eps:184,  roe:12.8, roa:4.2,  der:1.8,  div:2.4,  net_margin:9.4,  eps_growth:8.4,  rev_growth:6.2,  fcf_growth:14.2, pbv:0.8,  peg:0.74, ev_ebitda:4.8,  w52h:1480,  w52l:880,   beta:1.28, rsi:58, macd:'bullish',  vol_chg_30d:18,  rel_strength:6.8,  foreign_flow:48,   inst_own:32, insider:'neutral', sentiment:62, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'AMMN',  name:'Amman Mineral Internasional',sector:'Mining',         price:8125,   change:6.24,  volume:14_200_000,   mktcap:'192B',  mktcapRaw:192e9,  currency:'IDR', pe:18.4, eps:441,  roe:28.4, roa:14.8, der:0.6,  div:0.4,  net_margin:32.4, eps_growth:142.4,rev_growth:88.2, fcf_growth:124.8,pbv:5.2,  peg:0.13, ev_ebitda:10.2, w52h:10200, w52l:4200,  beta:1.74, rsi:71, macd:'bullish',  vol_chg_30d:48,  rel_strength:16.4, foreign_flow:842,  inst_own:28, insider:'buying',  sentiment:82, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'SMGR',  name:'Semen Indonesia',            sector:'Industrials',    price:3550,   change:-1.38, volume:9_400_000,    mktcap:'21B',   mktcapRaw:21e9,   currency:'IDR', pe:11.2, eps:317,  roe:8.4,  roa:4.8,  der:0.8,  div:3.2,  net_margin:8.8,  eps_growth:-2.8, rev_growth:3.4,  fcf_growth:-4.2, pbv:0.9,  peg:null, ev_ebitda:6.8,  w52h:4870,  w52l:3120,  beta:0.84, rsi:42, macd:'bearish',  vol_chg_30d:-12, rel_strength:-3.4, foreign_flow:-38,  inst_own:58, insider:'neutral', sentiment:44, rate_env:'stable',  inflation:'rising',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'INTP',  name:'Indocement Tunggal Prakarsa',sector:'Industrials',    price:8050,   change:-2.24, volume:4_200_000,    mktcap:'30B',   mktcapRaw:30e9,   currency:'IDR', pe:16.8, eps:479,  roe:7.8,  roa:6.4,  der:0.1,  div:4.1,  net_margin:11.2, eps_growth:-8.4, rev_growth:1.8,  fcf_growth:-6.2, pbv:1.3,  peg:null, ev_ebitda:8.4,  w52h:10400, w52l:7200,  beta:0.71, rsi:38, macd:'bearish',  vol_chg_30d:-18, rel_strength:-6.8, foreign_flow:-48,  inst_own:46, insider:'neutral', sentiment:38, rate_env:'stable',  inflation:'rising',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'MYOR',  name:'Mayora Indah',               sector:'Consumer',       price:2560,   change:0.39,  volume:7_800_000,    mktcap:'57B',   mktcapRaw:57e9,   currency:'IDR', pe:18.2, eps:141,  roe:16.4, roa:9.8,  der:0.6,  div:1.8,  net_margin:7.8,  eps_growth:12.4, rev_growth:9.8,  fcf_growth:8.2,  pbv:3.0,  peg:1.47, ev_ebitda:12.4, w52h:3100,  w52l:2100,  beta:0.72, rsi:52, macd:'neutral',  vol_chg_30d:4,   rel_strength:1.2,  foreign_flow:14,   inst_own:38, insider:'neutral', sentiment:58, rate_env:'stable',  inflation:'rising',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'ACES',  name:'Ace Hardware Indonesia',     sector:'Consumer',       price:820,    change:1.86,  volume:12_400_000,   mktcap:'14B',   mktcapRaw:14e9,   currency:'IDR', pe:22.4, eps:37,   roe:18.4, roa:14.2, der:0.1,  div:2.2,  net_margin:11.4, eps_growth:14.2, rev_growth:11.8, fcf_growth:12.4, pbv:4.1,  peg:1.58, ev_ebitda:14.2, w52h:1060,  w52l:680,   beta:0.82, rsi:56, macd:'bullish',  vol_chg_30d:14,  rel_strength:4.8,  foreign_flow:22,   inst_own:26, insider:'neutral', sentiment:64, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'MNCN',  name:'Media Nusantara Citra',      sector:'Consumer',       price:1215,   change:1.25,  volume:16_800_000,   mktcap:'18B',   mktcapRaw:18e9,   currency:'IDR', pe:10.4, eps:117,  roe:12.4, roa:8.4,  der:0.2,  div:3.8,  net_margin:16.8, eps_growth:-4.8, rev_growth:2.4,  fcf_growth:-2.8, pbv:1.3,  peg:null, ev_ebitda:7.8,  w52h:1620,  w52l:1050,  beta:0.94, rsi:48, macd:'neutral',  vol_chg_30d:-2,  rel_strength:0.2,  foreign_flow:-8,   inst_own:42, insider:'neutral', sentiment:52, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'TOWR',  name:'Sarana Menara Nusantara',    sector:'Infrastructure', price:990,    change:0.20,  volume:8_200_000,    mktcap:'20B',   mktcapRaw:20e9,   currency:'IDR', pe:16.4, eps:60,   roe:24.4, roa:6.8,  der:2.4,  div:4.2,  net_margin:22.4, eps_growth:8.8,  rev_growth:6.2,  fcf_growth:12.4, pbv:4.0,  peg:1.86, ev_ebitda:10.4, w52h:1280,  w52l:840,   beta:0.68, rsi:50, macd:'neutral',  vol_chg_30d:2,   rel_strength:0.8,  foreign_flow:14,   inst_own:48, insider:'neutral', sentiment:60, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'ISAT',  name:'Indosat Ooredoo Hutchison',  sector:'Infrastructure', price:10250,  change:2.41,  volume:5_800_000,    mktcap:'57B',   mktcapRaw:57e9,   currency:'IDR', pe:12.8, eps:801,  roe:9.4,  roa:2.8,  der:1.8,  div:1.4,  net_margin:6.8,  eps_growth:128.4,rev_growth:18.4, fcf_growth:82.4, pbv:1.2,  peg:0.10, ev_ebitda:4.8,  w52h:12400, w52l:7800,  beta:0.88, rsi:62, macd:'bullish',  vol_chg_30d:18,  rel_strength:7.2,  foreign_flow:84,   inst_own:44, insider:'buying',  sentiment:72, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'ERAA',  name:'Erajaya Swasembada',         sector:'Consumer',       price:480,    change:2.56,  volume:14_200_000,   mktcap:'4B',    mktcapRaw:4e9,    currency:'IDR', pe:7.2,  eps:67,   roe:12.4, roa:6.8,  der:0.4,  div:3.4,  net_margin:2.8,  eps_growth:18.4, rev_growth:12.4, fcf_growth:14.8, pbv:0.9,  peg:0.39, ev_ebitda:5.2,  w52h:640,   w52l:360,   beta:1.08, rsi:58, macd:'bullish',  vol_chg_30d:16,  rel_strength:5.4,  foreign_flow:8,    inst_own:18, insider:'neutral', sentiment:62, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'BTPS',  name:'Bank BTPN Syariah',          sector:'Banking',        price:1020,   change:-2.11, volume:8_400_000,    mktcap:'11B',   mktcapRaw:11e9,   currency:'IDR', pe:9.2,  eps:111,  roe:14.8, roa:8.4,  der:3.8,  div:5.2,  net_margin:28.4, eps_growth:-12.4,rev_growth:-8.2, fcf_growth:-14.8,pbv:1.4,  peg:null, ev_ebitda:6.4,  w52h:1480,  w52l:880,   beta:0.88, rsi:38, macd:'bearish',  vol_chg_30d:-22, rel_strength:-7.8, foreign_flow:-48,  inst_own:38, insider:'neutral', sentiment:38, rate_env:'stable',  inflation:'rising',  gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'HRUM',  name:'Harum Energy',               sector:'Mining',         price:1380,   change:3.38,  volume:22_400_000,   mktcap:'4B',    mktcapRaw:4e9,    currency:'IDR', pe:4.8,  eps:288,  roe:24.8, roa:18.4, der:0.0,  div:12.4, net_margin:18.4, eps_growth:-28.4,rev_growth:-14.2,fcf_growth:-22.4,pbv:1.2,  peg:null, ev_ebitda:2.8,  w52h:1820,  w52l:1050,  beta:1.24, rsi:62, macd:'bullish',  vol_chg_30d:24,  rel_strength:8.4,  foreign_flow:28,   inst_own:24, insider:'neutral', sentiment:64, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'FILM',  name:'MD Pictures',                sector:'Consumer',       price:2100,   change:7.14,  volume:8_800_000,    mktcap:'4B',    mktcapRaw:4e9,    currency:'IDR', pe:14.2, eps:148,  roe:14.4, roa:9.8,  der:0.2,  div:2.4,  net_margin:14.8, eps_growth:48.4, rev_growth:38.2, fcf_growth:42.4, pbv:2.1,  peg:0.29, ev_ebitda:9.4,  w52h:2640,  w52l:1280,  beta:1.42, rsi:72, macd:'bullish',  vol_chg_30d:58,  rel_strength:16.4, foreign_flow:18,   inst_own:14, insider:'buying',  sentiment:78, rate_env:'stable',  inflation:'stable',  gdp_trend:'growing',  idx_trend:'uptrend' },
];

const US_STOCKS_DATA = [
    // ── Mega Caps ──────────────────────────────────────────────────────────────
    { symbol:'NVDA',  name:'NVIDIA Corp.',                    sector:'Technology',   exchange:'NASDAQ', price:875.40,  change:4.82,  volume:42_300_000,  mktcap:'2.15T', mktcapRaw:2150e9, currency:'USD', pe:68.2, eps:12.84, roe:91.4, roa:55.4, der:0.41, div:0.03, net_margin:55.4, eps_growth:168.4,rev_growth:122.4,fcf_growth:184.2,pbv:62.4, peg:0.40, ev_ebitda:42.4, w52h:974.0,  w52l:410.0,  beta:1.92, rsi:64, macd:'bullish',  vol_chg_30d:42,  rel_strength:18.4, foreign_flow:null, inst_own:72, insider:'neutral', sentiment:82, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'AAPL',  name:'Apple Inc.',                      sector:'Technology',   exchange:'NASDAQ', price:228.50,  change:0.74,  volume:55_100_000,  mktcap:'3.51T', mktcapRaw:3510e9, currency:'USD', pe:31.4, eps:7.28,  roe:147.3,roa:28.4, der:1.77, div:0.51, net_margin:26.4, eps_growth:8.4,  rev_growth:4.8,  fcf_growth:12.4, pbv:46.2, peg:3.74, ev_ebitda:24.2, w52h:237.2,  w52l:164.1,  beta:1.21, rsi:52, macd:'neutral',  vol_chg_30d:6,   rel_strength:2.4,  foreign_flow:null, inst_own:78, insider:'selling', sentiment:68, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'MSFT',  name:'Microsoft Corp.',                 sector:'Technology',   exchange:'NASDAQ', price:418.30,  change:1.23,  volume:22_400_000,  mktcap:'3.11T', mktcapRaw:3110e9, currency:'USD', pe:36.1, eps:11.59, roe:43.1, roa:18.2, der:0.31, div:0.68, net_margin:35.8, eps_growth:22.4, rev_growth:16.8, fcf_growth:18.4, pbv:15.6, peg:1.61, ev_ebitda:28.4, w52h:468.4,  w52l:309.5,  beta:0.88, rsi:56, macd:'bullish',  vol_chg_30d:12,  rel_strength:5.8,  foreign_flow:null, inst_own:74, insider:'neutral', sentiment:74, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'GOOGL', name:'Alphabet Inc.',                   sector:'Technology',   exchange:'NASDAQ', price:192.75,  change:2.15,  volume:19_800_000,  mktcap:'2.37T', mktcapRaw:2370e9, currency:'USD', pe:23.8, eps:8.09,  roe:30.2, roa:16.4, der:0.11, div:0,    net_margin:28.4, eps_growth:28.4, rev_growth:12.8, fcf_growth:24.2, pbv:7.2,  peg:0.84, ev_ebitda:18.4, w52h:208.7,  w52l:120.2,  beta:1.04, rsi:58, macd:'bullish',  vol_chg_30d:14,  rel_strength:6.2,  foreign_flow:null, inst_own:68, insider:'neutral', sentiment:72, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'AMZN',  name:'Amazon.com Inc.',                 sector:'Consumer',     exchange:'NASDAQ', price:210.40,  change:1.88,  volume:31_600_000,  mktcap:'2.21T', mktcapRaw:2210e9, currency:'USD', pe:44.2, eps:4.76,  roe:21.8, roa:8.4,  der:0.62, div:0,    net_margin:9.4,  eps_growth:84.2, rev_growth:12.4, fcf_growth:124.2,pbv:9.6,  peg:0.52, ev_ebitda:18.2, w52h:230.0,  w52l:118.0,  beta:1.17, rsi:62, macd:'bullish',  vol_chg_30d:18,  rel_strength:7.8,  foreign_flow:null, inst_own:72, insider:'neutral', sentiment:76, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'META',  name:'Meta Platforms Inc.',             sector:'Technology',   exchange:'NASDAQ', price:607.20,  change:2.67,  volume:14_200_000,  mktcap:'1.54T', mktcapRaw:1540e9, currency:'USD', pe:27.1, eps:22.40, roe:37.8, roa:22.4, der:0.29, div:0.40, net_margin:38.4, eps_growth:68.4, rev_growth:22.4, fcf_growth:72.4, pbv:10.2, peg:0.40, ev_ebitda:20.2, w52h:740.9,  w52l:381.3,  beta:1.32, rsi:58, macd:'bullish',  vol_chg_30d:18,  rel_strength:8.2,  foreign_flow:null, inst_own:76, insider:'selling', sentiment:74, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'TSLA',  name:'Tesla Inc.',                      sector:'Consumer',     exchange:'NASDAQ', price:248.60,  change:-3.41, volume:88_500_000,  mktcap:'793B',  mktcapRaw:793e9,  currency:'USD', pe:82.4, eps:3.02,  roe:14.4, roa:8.2,  der:0.18, div:0,    net_margin:8.2,  eps_growth:-24.4,rev_growth:2.4,  fcf_growth:-38.4,pbv:11.8, peg:null, ev_ebitda:58.4, w52h:414.5,  w52l:138.8,  beta:2.34, rsi:42, macd:'bearish',  vol_chg_30d:-28, rel_strength:-12.4,foreign_flow:null, inst_own:48, insider:'selling', sentiment:38, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'downtrend' },
    // ── Large Caps — Financials ────────────────────────────────────────────────
    { symbol:'JPM',   name:'JPMorgan Chase & Co.',            sector:'Financials',   exchange:'NYSE',   price:228.10,  change:0.95,  volume:9_800_000,   mktcap:'655B',  mktcapRaw:655e9,  currency:'USD', pe:12.1, eps:18.85, roe:16.4, roa:1.4,  der:1.26, div:2.31, net_margin:28.4, eps_growth:18.4, rev_growth:12.4, fcf_growth:14.2, pbv:2.0,  peg:0.66, ev_ebitda:null, w52h:260.1,  w52l:183.6,  beta:1.13, rsi:58, macd:'bullish',  vol_chg_30d:8,   rel_strength:4.2,  foreign_flow:null, inst_own:78, insider:'neutral', sentiment:68, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'BAC',   name:'Bank of America Corp.',           sector:'Financials',   exchange:'NYSE',   price:41.30,   change:1.76,  volume:38_900_000,  mktcap:'324B',  mktcapRaw:324e9,  currency:'USD', pe:13.6, eps:3.04,  roe:9.8,  roa:0.9,  der:1.11, div:2.67, net_margin:18.4, eps_growth:12.4, rev_growth:6.8,  fcf_growth:10.2, pbv:1.3,  peg:1.10, ev_ebitda:null, w52h:48.1,   w52l:26.9,   beta:1.38, rsi:56, macd:'bullish',  vol_chg_30d:12,  rel_strength:4.8,  foreign_flow:null, inst_own:72, insider:'neutral', sentiment:62, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'WFC',   name:'Wells Fargo & Co.',               sector:'Financials',   exchange:'NYSE',   price:62.40,   change:0.48,  volume:18_400_000,  mktcap:'230B',  mktcapRaw:230e9,  currency:'USD', pe:11.8, eps:5.29,  roe:11.2, roa:1.1,  der:1.04, div:2.57, net_margin:20.4, eps_growth:14.8, rev_growth:4.2,  fcf_growth:18.4, pbv:1.3,  peg:0.80, ev_ebitda:null, w52h:72.6,   w52l:38.2,   beta:1.24, rsi:52, macd:'neutral',  vol_chg_30d:6,   rel_strength:2.4,  foreign_flow:null, inst_own:74, insider:'neutral', sentiment:60, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'GS',    name:'Goldman Sachs Group',             sector:'Financials',   exchange:'NYSE',   price:508.20,  change:1.84,  volume:4_200_000,   mktcap:'171B',  mktcapRaw:171e9,  currency:'USD', pe:14.2, eps:35.79, roe:12.4, roa:1.0,  der:4.88, div:2.68, net_margin:22.4, eps_growth:68.4, rev_growth:18.4, fcf_growth:82.4, pbv:1.7,  peg:0.21, ev_ebitda:null, w52h:582.8,  w52l:342.1,  beta:1.44, rsi:62, macd:'bullish',  vol_chg_30d:16,  rel_strength:7.2,  foreign_flow:null, inst_own:78, insider:'buying',  sentiment:72, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'uptrend' },
    // ── Large Caps — Healthcare ────────────────────────────────────────────────
    { symbol:'JNJ',   name:'Johnson & Johnson',               sector:'Healthcare',   exchange:'NYSE',   price:158.70,  change:-0.33, volume:7_200_000,   mktcap:'382B',  mktcapRaw:382e9,  currency:'USD', pe:15.4, eps:10.30, roe:22.8, roa:9.4,  der:0.51, div:2.99, net_margin:18.4, eps_growth:6.8,  rev_growth:4.2,  fcf_growth:8.4,  pbv:3.5,  peg:2.26, ev_ebitda:11.2, w52h:175.2,  w52l:144.0,  beta:0.57, rsi:44, macd:'neutral',  vol_chg_30d:-4,  rel_strength:-1.4, foreign_flow:null, inst_own:76, insider:'neutral', sentiment:54, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'UNH',   name:'UnitedHealth Group',              sector:'Healthcare',   exchange:'NYSE',   price:538.90,  change:-1.22, volume:4_100_000,   mktcap:'497B',  mktcapRaw:497e9,  currency:'USD', pe:18.6, eps:28.98, roe:26.7, roa:8.2,  der:0.72, div:1.81, net_margin:6.4,  eps_growth:12.4, rev_growth:9.8,  fcf_growth:10.2, pbv:5.0,  peg:1.50, ev_ebitda:12.4, w52h:630.7,  w52l:425.0,  beta:0.61, rsi:46, macd:'neutral',  vol_chg_30d:-6,  rel_strength:-2.2, foreign_flow:null, inst_own:84, insider:'neutral', sentiment:56, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'LLY',   name:'Eli Lilly & Co.',                 sector:'Healthcare',   exchange:'NYSE',   price:848.20,  change:2.88,  volume:3_800_000,   mktcap:'804B',  mktcapRaw:804e9,  currency:'USD', pe:68.4, eps:12.40, roe:62.4, roa:18.4, der:1.82, div:0.62, net_margin:22.4, eps_growth:102.4,rev_growth:32.4, fcf_growth:84.2, pbv:42.4, peg:0.67, ev_ebitda:48.4, w52h:972.4,  w52l:482.8,  beta:0.42, rsi:62, macd:'bullish',  vol_chg_30d:18,  rel_strength:8.4,  foreign_flow:null, inst_own:82, insider:'neutral', sentiment:78, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'PFE',   name:'Pfizer Inc.',                     sector:'Healthcare',   exchange:'NYSE',   price:27.40,   change:-2.19, volume:42_100_000,  mktcap:'155B',  mktcapRaw:155e9,  currency:'USD', pe:null, eps:-0.41, roe:-2.2, roa:-0.8, der:0.57, div:6.57, net_margin:-2.4, eps_growth:null, rev_growth:-42.4,fcf_growth:null, pbv:1.4,  peg:null, ev_ebitda:null, w52h:34.1,   w52l:25.2,   beta:0.56, rsi:36, macd:'bearish',  vol_chg_30d:-18, rel_strength:-8.4, foreign_flow:null, inst_own:72, insider:'neutral', sentiment:28, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'downtrend' },
    { symbol:'ABBV',  name:'AbbVie Inc.',                     sector:'Healthcare',   exchange:'NYSE',   price:184.20,  change:1.12,  volume:6_400_000,   mktcap:'325B',  mktcapRaw:325e9,  currency:'USD', pe:48.4, eps:3.80,  roe:null, roa:4.8,  der:null, div:3.49, net_margin:10.4, eps_growth:18.4, rev_growth:4.8,  fcf_growth:14.2, pbv:null, peg:2.63, ev_ebitda:14.2, w52h:204.2,  w52l:138.8,  beta:0.62, rsi:54, macd:'bullish',  vol_chg_30d:8,   rel_strength:3.2,  foreign_flow:null, inst_own:76, insider:'neutral', sentiment:64, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    // ── Large Caps — Energy ────────────────────────────────────────────────────
    { symbol:'XOM',   name:'ExxonMobil Corp.',                sector:'Energy',       exchange:'NYSE',   price:106.40,  change:1.14,  volume:16_300_000,  mktcap:'458B',  mktcapRaw:458e9,  currency:'USD', pe:14.2, eps:7.49,  roe:15.8, roa:8.2,  der:0.20, div:3.68, net_margin:10.4, eps_growth:-8.4, rev_growth:-4.2, fcf_growth:4.8,  pbv:2.2,  peg:null, ev_ebitda:7.8,  w52h:123.7,  w52l:95.8,   beta:0.93, rsi:50, macd:'neutral',  vol_chg_30d:4,   rel_strength:1.2,  foreign_flow:null, inst_own:68, insider:'neutral', sentiment:56, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'CVX',   name:'Chevron Corp.',                   sector:'Energy',       exchange:'NYSE',   price:152.80,  change:0.62,  volume:8_700_000,   mktcap:'279B',  mktcapRaw:279e9,  currency:'USD', pe:14.9, eps:10.25, roe:12.4, roa:6.8,  der:0.14, div:4.15, net_margin:9.4,  eps_growth:-12.4,rev_growth:-8.4, fcf_growth:2.4,  pbv:1.8,  peg:null, ev_ebitda:7.2,  w52h:168.9,  w52l:134.8,  beta:0.88, rsi:48, macd:'neutral',  vol_chg_30d:2,   rel_strength:0.2,  foreign_flow:null, inst_own:66, insider:'neutral', sentiment:54, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'COP',   name:'ConocoPhillips',                  sector:'Energy',       exchange:'NYSE',   price:114.60,  change:2.38,  volume:9_100_000,   mktcap:'138B',  mktcapRaw:138e9,  currency:'USD', pe:12.2, eps:9.39,  roe:18.3, roa:10.4, der:0.40, div:2.90, net_margin:18.4, eps_growth:-6.2, rev_growth:-2.4, fcf_growth:8.2,  pbv:2.2,  peg:null, ev_ebitda:5.8,  w52h:135.9,  w52l:98.1,   beta:0.94, rsi:54, macd:'bullish',  vol_chg_30d:8,   rel_strength:3.4,  foreign_flow:null, inst_own:72, insider:'buying',  sentiment:62, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    // ── Large Caps — Industrials ───────────────────────────────────────────────
    { symbol:'CAT',   name:'Caterpillar Inc.',                sector:'Industrials',  exchange:'NYSE',   price:381.50,  change:-0.58, volume:3_200_000,   mktcap:'189B',  mktcapRaw:189e9,  currency:'USD', pe:17.2, eps:22.18, roe:56.4, roa:14.4, der:1.52, div:1.73, net_margin:18.4, eps_growth:8.4,  rev_growth:2.4,  fcf_growth:12.4, pbv:9.6,  peg:2.05, ev_ebitda:12.4, w52h:418.5,  w52l:278.3,  beta:1.02, rsi:48, macd:'neutral',  vol_chg_30d:2,   rel_strength:0.4,  foreign_flow:null, inst_own:74, insider:'neutral', sentiment:56, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'GE',    name:'GE Aerospace',                    sector:'Industrials',  exchange:'NYSE',   price:188.70,  change:3.12,  volume:8_600_000,   mktcap:'204B',  mktcapRaw:204e9,  currency:'USD', pe:42.8, eps:4.41,  roe:34.7, roa:12.4, der:0.88, div:0.32, net_margin:14.8, eps_growth:84.2, rev_growth:18.4, fcf_growth:78.4, pbv:14.8, peg:0.51, ev_ebitda:28.4, w52h:213.5,  w52l:112.9,  beta:1.18, rsi:64, macd:'bullish',  vol_chg_30d:22,  rel_strength:9.4,  foreign_flow:null, inst_own:68, insider:'neutral', sentiment:74, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'BA',    name:'Boeing Co.',                      sector:'Industrials',  exchange:'NYSE',   price:163.20,  change:-4.87, volume:12_800_000,  mktcap:'102B',  mktcapRaw:102e9,  currency:'USD', pe:null, eps:-6.94, roe:null, roa:-4.4, der:null, div:0,    net_margin:-8.4, eps_growth:null, rev_growth:18.4, fcf_growth:null, pbv:null, peg:null, ev_ebitda:null, w52h:228.0,  w52l:159.7,  beta:1.44, rsi:34, macd:'bearish',  vol_chg_30d:-28, rel_strength:-12.4,foreign_flow:null, inst_own:72, insider:'selling', sentiment:28, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'downtrend' },
    { symbol:'RTX',   name:'RTX Corp. (Raytheon)',            sector:'Industrials',  exchange:'NYSE',   price:122.40,  change:1.42,  volume:6_800_000,   mktcap:'162B',  mktcapRaw:162e9,  currency:'USD', pe:22.4, eps:5.46,  roe:8.4,  roa:3.8,  der:0.72, div:2.22, net_margin:6.8,  eps_growth:14.4, rev_growth:8.2,  fcf_growth:12.4, pbv:1.9,  peg:1.56, ev_ebitda:14.2, w52h:134.8,  w52l:82.4,   beta:0.84, rsi:56, macd:'bullish',  vol_chg_30d:10,  rel_strength:4.2,  foreign_flow:null, inst_own:76, insider:'neutral', sentiment:64, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    // ── Large Caps — Consumer / Retail ────────────────────────────────────────
    { symbol:'WMT',   name:'Walmart Inc.',                    sector:'Consumer',     exchange:'NYSE',   price:96.30,   change:1.51,  volume:11_400_000,  mktcap:'773B',  mktcapRaw:773e9,  currency:'USD', pe:38.1, eps:2.53,  roe:22.1, roa:7.8,  der:0.64, div:1.30, net_margin:2.4,  eps_growth:22.4, rev_growth:5.4,  fcf_growth:18.4, pbv:8.4,  peg:1.70, ev_ebitda:18.4, w52h:105.3,  w52l:60.2,   beta:0.67, rsi:58, macd:'bullish',  vol_chg_30d:12,  rel_strength:5.2,  foreign_flow:null, inst_own:72, insider:'neutral', sentiment:68, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'COST',  name:'Costco Wholesale Corp.',          sector:'Consumer',     exchange:'NASDAQ', price:918.40,  change:0.84,  volume:2_800_000,   mktcap:'407B',  mktcapRaw:407e9,  currency:'USD', pe:56.4, eps:16.28, roe:28.4, roa:10.8, der:0.31, div:0.78, net_margin:2.8,  eps_growth:14.4, rev_growth:6.8,  fcf_growth:12.4, pbv:16.0, peg:3.92, ev_ebitda:28.4, w52h:1024.2, w52l:614.2,  beta:0.72, rsi:54, macd:'neutral',  vol_chg_30d:4,   rel_strength:1.8,  foreign_flow:null, inst_own:76, insider:'neutral', sentiment:66, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'MCD',   name:"McDonald's Corp.",                sector:'Consumer',     exchange:'NYSE',   price:298.40,  change:0.34,  volume:3_200_000,   mktcap:'215B',  mktcapRaw:215e9,  currency:'USD', pe:24.2, eps:12.33, roe:null, roa:14.4, der:null, div:2.40, net_margin:32.4, eps_growth:8.4,  rev_growth:2.4,  fcf_growth:10.2, pbv:null, peg:2.88, ev_ebitda:18.4, w52h:320.8,  w52l:246.8,  beta:0.72, rsi:50, macd:'neutral',  vol_chg_30d:2,   rel_strength:0.4,  foreign_flow:null, inst_own:74, insider:'neutral', sentiment:58, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    // ── Large Caps — Technology ────────────────────────────────────────────────
    { symbol:'AMD',   name:'Advanced Micro Devices',          sector:'Technology',   exchange:'NASDAQ', price:178.50,  change:5.43,  volume:61_200_000,  mktcap:'289B',  mktcapRaw:289e9,  currency:'USD', pe:214.3,eps:0.83,  roe:2.4,  roa:1.2,  der:0.06, div:0,    net_margin:1.4,  eps_growth:142.4,rev_growth:14.2, fcf_growth:224.4,pbv:5.2,  peg:1.51, ev_ebitda:42.4, w52h:226.0,  w52l:121.6,  beta:1.78, rsi:66, macd:'bullish',  vol_chg_30d:38,  rel_strength:14.4, foreign_flow:null, inst_own:68, insider:'neutral', sentiment:72, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'CRM',   name:'Salesforce Inc.',                 sector:'Technology',   exchange:'NYSE',   price:302.40,  change:1.24,  volume:5_800_000,   mktcap:'292B',  mktcapRaw:292e9,  currency:'USD', pe:44.8, eps:6.75,  roe:9.8,  roa:5.4,  der:0.16, div:0,    net_margin:15.2, eps_growth:18.4, rev_growth:9.8,  fcf_growth:28.4, pbv:4.4,  peg:2.43, ev_ebitda:24.2, w52h:348.4,  w52l:212.0,  beta:1.12, rsi:54, macd:'bullish',  vol_chg_30d:12,  rel_strength:4.8,  foreign_flow:null, inst_own:72, insider:'neutral', sentiment:64, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'ORCL',  name:'Oracle Corp.',                    sector:'Technology',   exchange:'NYSE',   price:148.60,  change:2.18,  volume:8_400_000,   mktcap:'408B',  mktcapRaw:408e9,  currency:'USD', pe:32.4, eps:4.59,  roe:null, roa:8.4,  der:null, div:1.08, net_margin:22.4, eps_growth:28.4, rev_growth:8.2,  fcf_growth:22.4, pbv:null, peg:1.14, ev_ebitda:18.4, w52h:192.4,  w52l:98.4,   beta:0.94, rsi:58, macd:'bullish',  vol_chg_30d:16,  rel_strength:7.2,  foreign_flow:null, inst_own:68, insider:'neutral', sentiment:68, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'NFLX',  name:'Netflix Inc.',                    sector:'Technology',   exchange:'NASDAQ', price:724.80,  change:1.68,  volume:4_200_000,   mktcap:'311B',  mktcapRaw:311e9,  currency:'USD', pe:44.2, eps:16.40, roe:32.4, roa:14.8, der:0.68, div:0,    net_margin:20.4, eps_growth:64.2, rev_growth:14.8, fcf_growth:128.4,pbv:14.4, peg:0.69, ev_ebitda:28.4, w52h:764.2,  w52l:378.2,  beta:1.24, rsi:62, macd:'bullish',  vol_chg_30d:22,  rel_strength:9.8,  foreign_flow:null, inst_own:78, insider:'neutral', sentiment:74, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'AVGO',  name:'Broadcom Inc.',                   sector:'Technology',   exchange:'NASDAQ', price:228.40,  change:3.24,  volume:12_800_000,  mktcap:'1.07T', mktcapRaw:1070e9, currency:'USD', pe:42.4, eps:5.39,  roe:28.4, roa:12.4, der:1.28, div:1.75, net_margin:18.4, eps_growth:14.4, rev_growth:44.2, fcf_growth:12.4, pbv:12.0, peg:2.94, ev_ebitda:28.4, w52h:251.8,  w52l:102.4,  beta:1.22, rsi:62, macd:'bullish',  vol_chg_30d:24,  rel_strength:10.4, foreign_flow:null, inst_own:76, insider:'neutral', sentiment:72, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'INTC',  name:'Intel Corp.',                     sector:'Technology',   exchange:'NASDAQ', price:24.80,   change:-1.82, volume:48_400_000,  mktcap:'104B',  mktcapRaw:104e9,  currency:'USD', pe:null, eps:-4.38, roe:null, roa:-8.4, der:0.47, div:0,    net_margin:-42.4,eps_growth:null, rev_growth:-2.4, fcf_growth:null, pbv:1.0,  peg:null, ev_ebitda:null, w52h:46.4,   w52l:18.5,   beta:1.18, rsi:38, macd:'bearish',  vol_chg_30d:-22, rel_strength:-9.4, foreign_flow:null, inst_own:68, insider:'buying',  sentiment:32, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    // ── Diversified ───────────────────────────────────────────────────────────
    { symbol:'BRK.B', name:'Berkshire Hathaway B',            sector:'Financials',   exchange:'NYSE',   price:472.40,  change:0.28,  volume:3_800_000,   mktcap:'1.06T', mktcapRaw:1060e9, currency:'USD', pe:24.4, eps:19.36, roe:13.4, roa:4.8,  der:0.18, div:0,    net_margin:18.4, eps_growth:18.4, rev_growth:4.2,  fcf_growth:14.2, pbv:1.6,  peg:1.33, ev_ebitda:12.4, w52h:502.8,  w52l:342.8,  beta:0.82, rsi:52, macd:'neutral',  vol_chg_30d:4,   rel_strength:1.4,  foreign_flow:null, inst_own:62, insider:'neutral', sentiment:64, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'V',     name:'Visa Inc.',                       sector:'Financials',   exchange:'NYSE',   price:312.80,  change:0.62,  volume:7_400_000,   mktcap:'632B',  mktcapRaw:632e9,  currency:'USD', pe:32.4, eps:9.65,  roe:42.4, roa:21.4, der:0.58, div:0.83, net_margin:52.4, eps_growth:14.4, rev_growth:9.8,  fcf_growth:12.4, pbv:13.8, peg:2.25, ev_ebitda:24.4, w52h:334.4,  w52l:225.8,  beta:0.92, rsi:56, macd:'bullish',  vol_chg_30d:10,  rel_strength:4.2,  foreign_flow:null, inst_own:80, insider:'neutral', sentiment:70, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'MA',    name:'Mastercard Inc.',                  sector:'Financials',   exchange:'NYSE',   price:518.20,  change:0.88,  volume:3_200_000,   mktcap:'492B',  mktcapRaw:492e9,  currency:'USD', pe:38.4, eps:13.49, roe:142.4,roa:26.4, der:2.12, div:0.66, net_margin:44.4, eps_growth:18.4, rev_growth:12.4, fcf_growth:14.2, pbv:54.8, peg:2.08, ev_ebitda:28.4, w52h:554.4,  w52l:388.2,  beta:0.94, rsi:58, macd:'bullish',  vol_chg_30d:12,  rel_strength:5.4,  foreign_flow:null, inst_own:82, insider:'neutral', sentiment:72, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'KO',    name:'Coca-Cola Co.',                   sector:'Consumer',     exchange:'NYSE',   price:72.40,   change:0.28,  volume:14_800_000,  mktcap:'311B',  mktcapRaw:311e9,  currency:'USD', pe:27.8, eps:2.60,  roe:38.4, roa:10.4, der:1.52, div:3.09, net_margin:22.4, eps_growth:6.8,  rev_growth:3.4,  fcf_growth:8.4,  pbv:10.7, peg:4.10, ev_ebitda:22.4, w52h:75.4,   w52l:57.8,   beta:0.57, rsi:52, macd:'neutral',  vol_chg_30d:2,   rel_strength:0.4,  foreign_flow:null, inst_own:72, insider:'neutral', sentiment:60, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'PG',    name:'Procter & Gamble Co.',            sector:'Consumer',     exchange:'NYSE',   price:168.40,  change:0.42,  volume:7_200_000,   mktcap:'397B',  mktcapRaw:397e9,  currency:'USD', pe:27.2, eps:6.19,  roe:32.4, roa:12.4, der:0.64, div:2.38, net_margin:18.4, eps_growth:12.4, rev_growth:4.8,  fcf_growth:10.2, pbv:8.8,  peg:2.20, ev_ebitda:20.4, w52h:180.4,  w52l:147.2,  beta:0.52, rsi:54, macd:'neutral',  vol_chg_30d:4,   rel_strength:1.2,  foreign_flow:null, inst_own:76, insider:'neutral', sentiment:62, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'sideways' },
    { symbol:'PLTR',  name:'Palantir Technologies',           sector:'Technology',   exchange:'NYSE',   price:84.20,   change:6.18,  volume:68_400_000,  mktcap:'181B',  mktcapRaw:181e9,  currency:'USD', pe:212.4,eps:0.40,  roe:8.4,  roa:6.4,  der:0.00, div:0,    net_margin:14.4, eps_growth:228.4,rev_growth:28.4, fcf_growth:184.2,pbv:17.8, peg:0.93, ev_ebitda:142.4,w52h:125.4,  w52l:16.8,   beta:2.12, rsi:74, macd:'bullish',  vol_chg_30d:82,  rel_strength:24.4, foreign_flow:null, inst_own:28, insider:'selling', sentiment:78, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'COIN',  name:'Coinbase Global Inc.',            sector:'Financials',   exchange:'NASDAQ', price:248.80,  change:8.42,  volume:14_200_000,  mktcap:'63B',   mktcapRaw:63e9,   currency:'USD', pe:24.2, eps:10.28, roe:28.4, roa:12.4, der:0.18, div:0,    net_margin:18.4, eps_growth:null, rev_growth:82.4, fcf_growth:null, pbv:6.8,  peg:null, ev_ebitda:18.4, w52h:349.8,  w52l:115.0,  beta:2.84, rsi:68, macd:'bullish',  vol_chg_30d:62,  rel_strength:18.4, foreign_flow:null, inst_own:48, insider:'neutral', sentiment:74, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'uptrend' },
    { symbol:'SNOW',  name:'Snowflake Inc.',                  sector:'Technology',   exchange:'NYSE',   price:168.40,  change:4.28,  volume:8_400_000,   mktcap:'57B',   mktcapRaw:57e9,   currency:'USD', pe:null, eps:-2.08, roe:-24.4,roa:-8.4, der:0.00, div:0,    net_margin:-24.4,eps_growth:48.4, rev_growth:28.4, fcf_growth:82.4, pbv:8.4,  peg:null, ev_ebitda:null, w52h:238.4,  w52l:107.0,  beta:1.42, rsi:64, macd:'bullish',  vol_chg_30d:38,  rel_strength:12.4, foreign_flow:null, inst_own:68, insider:'buying',  sentiment:68, rate_env:'stable',  inflation:'falling', gdp_trend:'growing',  idx_trend:'uptrend' },
];
...
function renderStockMovers(market, type) {
    ...
    switch (type) {
        case 'gainers':
            data = [...allData].sort((a,b) => b.change - a.change);
            break;
        case 'losers':
            data = [...allData].sort((a,b) => a.change - b.change);
            break;
        case 'active':
            data = [...allData].sort((a,b) => b.volume - a.volume);
            break;
        case 'watchlist':
